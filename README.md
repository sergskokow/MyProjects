...
[**Find e to the Nth Digit**](https://github.com/sergskokow2/Projects/tree/master/numbers/spigotE.m) - Just like the previous problem, but with e instead of PI. Enter a number and have the program generate e up to that many decimal places. Keep a limit to how far the program will go.

[**Fibonacci Sequence**](https://github.com/sergskokow2/Projects/tree/master/numbers/Fibonacci.m) - Enter a number and have the program generate the Fibonacci sequence to that number or to the Nth number.
